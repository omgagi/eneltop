...
Ranking público en español. La portada muestra una selección editorial de 72 proyectos: 47 cuentas de Instagram y 25 webs latinoamericanas. Los importes se ordenan de 4,43 USD a 1,00 USD, sin empates; la siguiente oferta para el primer puesto es 4,44 USD. La oferta mínima de un proyecto nuevo es 0,50 USD. El control de precio admite centavos y no establece un máximo propio.
