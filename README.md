...
- El acceso por correo usa Postmark en producción desde el 18 de septiembre de 2026. La configuración, las comprobaciones y la rotación de claves están en [docs/correo.md](docs/correo.md). El código también admite Resend, pendiente de revisión de su cuenta. Sin clave de ningún proveedor, la solicitud de enlace responde 503. Los enlaces caducan a los 15 minutos, son de un solo uso y las sesiones duran 30 días.
